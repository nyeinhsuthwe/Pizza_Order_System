            ...
            <div class="col-lg-10 offset-1">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-success alert-dismissible fade show col-3 float-end" role="alert">
                            {{session('updateSuccess')}}
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        @endif
                        <form action="{{route('accountUpdate', Auth::user()->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
